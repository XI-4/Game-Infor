...
startback = pygame.image.load("splashback.jpg")
startback = pygame.transform.scale(startback, (800, 600))
...
Pause_Back = pygame.image.load("PAUSE.png")
Pause_Back.set_alpha(100)
Pause_Back = pygame.transform.scale(Pause_Back, (800, 600))
bar1_x, bar2_x = 10., 780.
bar1_y, bar2_y = 300., 300.
circle_x, circle_y = 307.5, 232.5
bar1_move, bar2_move = 0., 0.
speed_x, speed_y, speed_circ = 300., 300., 450.
bar1_score, bar2_score = 0, 0
clock = pygame.time.Clock()
font = pygame.font.Font("Font.TTF", 40)
msg_font = pygame.font.Font("Font.TTF", 30)
abt2_font = pygame.font.Font("Font.TTF", 50)
abt_font = pygame.font.Font("Font.TTF", 20)
...
About_MSG2 = abt_font.render("Pong 2 Player Game", True, (255, 255, 255))
...
About_MSG4 = abt_font.render("Developed by Nathan and Zarif", True, (255, 255, 255))
...
while run:
    ...
    middle_line = pygame.draw.aaline(
        screen, (255, 255, 255), (410, 5), (410, 675))
